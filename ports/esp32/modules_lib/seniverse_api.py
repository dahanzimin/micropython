...
_weather_now="https://api.seniverse.com/v3/weather/now.json?"			#天气实况 

_weather_daily="https://api.seniverse.com/v3/weather/daily.json?" 		#逐日天气预报
 
_weather_hourly="https://api.seniverse.com/v3/weather/hourly.json?"		#逐时天气预报

_weather_alarm="https://api.seniverse.com/v3/weather/alarm.json?"		#气象灾害预警

_life_suggestion="https://api.seniverse.com/v3/life/suggestion.json?"	#生活指数

_air_now="https://api.seniverse.com/v3/air/now.json?"					#空气质量实况	

_air_daily="https://api.seniverse.com/v3/air/daily.json?"				#逐日空气质量预报

_tide_daily="https://api.seniverse.com/v3/tide/daily.json?"				#逐小时潮汐预报

_geo_sun="https://api.seniverse.com/v3/geo/sun.json?"					#日出日落

_geo_moon="https://api.seniverse.com/v3/geo/moon.json?"					#月出月落和月相

_location_search="https://api.seniverse.com/v3/location/search.json?"	#城市搜索


#数据请求
def _urequests_api(url):
	try:
		results=json.loads(urequests.get(url).text)
	except :
		raise RuntimeError("API request failed or WiFi is not connected")
